<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SprStorageBuilding.aspx.cs" Inherits="WebApplication2.SprStorageBuilding" %>
...
<head id="Head1" runat="server">
    <title>Справочник мест хранения. Здания</title>
...
<body>
    <form id="frmDocView" runat="server">
        <div class="blockMain">
            ...
            <div class="blockSection" ID="pnlStorageBuilding" runat="server">
