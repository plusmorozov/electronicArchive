<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SprDocType.aspx.cs" Inherits="WebApplication2.SprDocType" %>
...
<body>
    <form id="frmDocView" runat="server">
        <div class="blockMain">
            ...
            <div class="blockSection" ID="pnlDocType" runat="server">
