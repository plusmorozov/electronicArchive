<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SprDepartment.aspx.cs" Inherits="WebApplication2.SprDepartment" %>
...
<head id="Head1" runat="server">
    <title>Справочник отделов</title>
...
<body>
    <form id="frmDocView" runat="server">
        <div class="blockMain">
            ...
            <div class="blockSection" ID="pnlDepartment" runat="server">
