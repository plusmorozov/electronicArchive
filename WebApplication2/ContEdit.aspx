<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContEdit.aspx.cs" Inherits="WebApplication2.WebForm6" %>
    ...
    <div class="blockMain">
        <div class="blockTitle" id="pnlTitle" runat="server" >
            <div class="blockSubSectionLeft">
                ...
                <asp:Label CssClass="elmTitle" ID="lblDocNum"   runat="server" Text="[ Редактирование ]"   ></asp:Label>
            </div>
        ...
        <div class="blockSection" ID="pnlDoc" runat="server">
            ...
            <div class="divClear"></div>    
            <div class="divClear"></div>
            <asp:Label        CssClass="elmLeft_MB8R10_NB_AL_W200"    ID="lblAttachName"      runat="server" Text="Прикрепленный файл" ></asp:Label>
            <div class="divClear"></div>    
            <div class="divClear"></div>        
            ...
            <div class="divClear"></div>    
            <div class="divClear"></div>        
            <asp:Label        CssClass="elmLeft_MB8R10_NB_AL_W200"    ID="lblAttach"      runat="server" Text="Заменить файл" ></asp:Label>
