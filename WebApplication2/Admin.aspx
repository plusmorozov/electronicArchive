<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="WebApplication2.Admin1" %>
...
<body>
    ...
    <div class="blockMain">
        ...
        <asp:Button CssClass="elmBtnR_M10" ID="btnDocCreate" runat="server" Text="Создать" 
                onclick="btnDocCreate_Click" />    
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="" ItemStyle-Width="100px">
                        <ItemTemplate>
                                ...
                                <asp:LinkButton runat="server" ID="BtnDocEdit" CommandName="DocEdit" CommandArgument='<%# Eval("ID") %>' ><i class="fa fa-edit fa-3x"></i></asp:LinkButton>    
