<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SprStatus.aspx.cs" Inherits="WebApplication2.SprStatus" %>
...
<head id="Head1" runat="server">
    <title>Справочник статусов оцифровки</title>
...
<body>
    <form id="frmDocView" runat="server">
        <div class="blockMain">
            ...
            <div class="blockSection" ID="pnlStatus" runat="server">
