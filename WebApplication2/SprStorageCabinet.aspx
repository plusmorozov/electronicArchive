<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SprStorageCabinet.aspx.cs" Inherits="WebApplication2.SprStorageCabinet" %>
...
<head id="Head1" runat="server">
    <title>Справочник мест хранения. Кабинет</title>
...
<body>
    <form id="frmDocView" runat="server">
        <div class="blockMain">
            ...
            <div class="blockSection" ID="pnlStorageCabinet" runat="server">
